...
class testGameMethods(unittest.TestCase):
    ...
    def testResetTurn(self):
        ...
        game.start_turn()
        game.increment_active_state(True)
        game.current_turn_bonus_points = 3
