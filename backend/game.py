...
class Game(object):
    ...
    def reset(
        ...
        self.current_turn_bonus_points: int = 0
    ...
    def __json__(self) -> Dict[str, Any]:  # pragma: no cover
        return {
            ...
            "current_turn_bonus_points": self.current_turn_bonus_points,
    ...
    def _calculate_bonus(self, time_left: float):
        ...
        if bonus:
            self.current_turn_bonus_points = bonus
    ...
    def _reset_turn(self):
        ...
        self.current_turn_bonus_points = 0
